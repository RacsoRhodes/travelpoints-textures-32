--------------------------------------------------------------------------------
--
-- Travelpoints Textures 32 1.0                                       2015-03-24
--
-- By Racso Rhodes
--
-- travelpoints-textures-32/readme.txt
--
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
	...
	About
		...
		32x32 textures for the Minetest mod "Travelpoints".
	...
	Install
		...
		For example, if you are using "HDX 32", you would move these files to
		the textures/HDX_32px directory in your Minetest installation directory.

	Travelpoints on GitHub
